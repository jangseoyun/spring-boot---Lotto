...
public class WinningAmountService {
     ...
     * 당회차 등위별 당첨금 계산
     */
    public WinningResult calcAmount(Long lottoCycleNum) {
        ...
        //등위별 금액 계산
        RankAmountCommand getRankAmount = calculatAmount.getWinningAmount(rankTotalCount, totalSellAmount); //TODO : 중간 등수에 당첨자가 없을 경우

        WinningResult winningResult = new WinningResult(getRankAmount, rankTotalCount);
